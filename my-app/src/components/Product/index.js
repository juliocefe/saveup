...
const DEFAULT_IMAGE =
  "https://bodegaaurrera.net/wp-content/uploads/2019/09/100185178-1.png";
        ...
        <div className="btn-Autocomplete__group">
          {!buying ? (
            <button
              ...
              className="btn btn-success btn-Autocomplete__add"
            >
              Add
            </button>
          ) : null}
          {buying ? (
            ...
            <button
              className="btn btn-danger btn-Autocomplete__delete"
              onClick={() => {
