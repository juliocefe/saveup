...
import { SearchInput, SearchBox,
     SearchContainer, PlusBtn } from  './styles'
...
export const Search = () => {
    ...
    return(
        <SearchContainer>
            <PlusBtn className={carList ? 'visible' : 'invisible'}>
            ...
            handleSendDatatoApi={handleSendDatatoApi} />
        </SearchContainer>
    );
}
